...
import { regData } from '../../common/components/registration/regData'
import Head from 'next/head'
const FirstRegForm = dynamic(
  () => import('../../common/components/registration/FirstRegForm'),
  { ssr: false }
)
const SecondRegForm = dynamic(
  () => import('../../common/components/registration/SecondRegForm'),
  { ssr: false }
)
const ThirdRegForm = dynamic(
  () => import('../../common/components/registration/ThirdRegForm'),
  { ssr: false }
)
